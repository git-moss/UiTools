...
package de.mossgrabers.tools.ui.panel;

import de.mossgrabers.tools.ui.BasicConfig;
import de.mossgrabers.tools.ui.Functions;
import de.mossgrabers.tools.ui.control.DropDownButton;
...
public abstract class BasePanel
{
    ...
    /**
     * Creates and adds a text field to the panel including a button which opens a folder selector
     * dialog when clicked. If a folder is selected its absolute path is set as the text of the
     * field.
     *
     * @param tooltip Tooltip text
     * @param buttonLabel The label to use for the button
     * @param dialogTitle The label to use as the title text in the folder select dialog
     * @param configuration The configuration to load/save the dialog settings (can be null)
     * @return The created text field
     */
    public TextField createFolderSelectField (final String tooltip, final String buttonLabel, final String dialogTitle, final BasicConfig configuration)
    {
        return this.createFolderSelectField (null, tooltip, buttonLabel, dialogTitle, configuration);
    }


    /**
     * Creates and adds a text field with label to the panel including a button which opens a folder
     * selector dialog when clicked. If a folder is selected its absolute path is set as the text of
     * the field.
     *
     * @param label The name of the label which is added to the field
     * @param tooltip Tooltip text
     ...
     * @return The created text field
     */
    public TextField createFolderSelectField (final String label, final String tooltip, final String buttonLabel, final String dialogTitle, final BasicConfig configuration)
    {
        final TextField field = new TextField ();
        ...
        selectButton.setOnAction (event -> {
            ...
            if (file.isPresent ())
                field.setText (file.get ().getAbsolutePath ());

        });
        field.setTooltip (new Tooltip (Functions.getText (tooltip)));
        this.addComponent (new BorderPane (field, null, selectButton, null, null), label, tooltip, false);
        return field;
    }
